...
const WatchSkeleton = () => {
  return (
    ...
    <div className="w-full h-[320px] relative loading bg-shadow-light dark:bg-shadow-dark object-cover rounded-sm bg-shadow"></div>
  ...
  <div className='hidden w-full md:grid gap-4 flex-[.5] '>
    <VideoSkeleton/>
    <VideoSkeleton/>
  </div>
       </div>
